        ...
        <div className={classes.field}>
          ...
          >
            <Grid
              ...
              md={12}
            >
              <BookingCard noWrap={true} title={bankList[bank ? bank : 0].name}  status={"Silahkan melakukan pembayaran ke nomor Rekening " + bankList[bank ? bank : 0].rek + " atas nama Celine"} />
            </Grid>
          </Grid>
        </div>
